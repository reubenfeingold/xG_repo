...
box = client.game_center.boxscore(game_id="2023020280")
...
away_roster = client.teams.team_roster(team_abbr=away_abbr, season="20232024")
home_roster = client.teams.team_roster(team_abbr=home_abbr, season="20232024")
